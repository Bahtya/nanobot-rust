//! Python kestrel JSON config schema definitions.
//!
//! These structs mirror the Python kestrel `config.json` format exactly,
...
/// Root Python kestrel config.json structure.
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct PythonConfig {
    /// Config version from Python kestrel.
...
pub struct PythonDiscordConfig {
    ...
    /// No kestrel equivalent — reported as unmapped.
    #[serde(default)]

...
Shared types, error definitions, and constants used across all nanobot crates.

Part of the [nanobot-rust](../..) workspace.

## Overview

This is the foundational crate that every other nanobot crate depends on. It defines
...
| `NanobotError` | Unified error enum (Config, Provider, Tool, Session, Security, etc.) |
...
```rust
use nanobot_core::{Message, MessageRole, Platform, ToolCall, Usage};
